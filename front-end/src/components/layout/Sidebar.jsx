...
import {
  ...
  BookOpen, Zap, MessageCircle, Bell, Settings, LogOut, ChevronRight,
  Users, BarChart3, TrendingUp, Store, X, Menu, Leaf, ShieldCheck,
} from "lucide-react";
...
const NAV_SHARED = [
  ...
  { to: "/pricing",             icon: TrendingUp,      label: "Price Trends" },
];
